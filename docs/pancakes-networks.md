...
# Nodes as Stewardship Boundaries
...
* local nodes to continue operating,
* exports to remain usable,
* identities to remain valid,
* records to remain accessible,
* communities to retain continuity.
...
# Knowledge Graphs Rather Than Databases
...
# Computation as a Network Capability
...
# Service Exchange Between Nodes
...
# Mesh Networks and Connectivity
