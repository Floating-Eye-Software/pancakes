...
This overlaps with Pitchfork's symbolic basic income model. Any real-money version belongs behind the economic safeguards in [Pitchfork Economics](https://github.com/mlehotay/pitchfork/blob/main/docs/pitchfork_economics.md).
