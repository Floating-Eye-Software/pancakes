...
- [Description](pancakes-playlist-description.md)
- [Liner notes](pancakes-playlist-liner-notes.md)
- [Histories](pancakes-playlist-histories.md)
- [Demands of the people](pancakes-playlist-demands.md)
...
The playlist is a cultural companion to Pancakes. It is about labor, care,
dignity, belonging, ecological stewardship, and ordinary human needs.

Use the overview first, then the liner notes and histories if you want the
sequence and its interpretation in order.
