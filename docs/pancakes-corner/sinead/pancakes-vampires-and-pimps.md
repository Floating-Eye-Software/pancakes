...
> — Sinéad O'Connor, **Saturday Night Live**, 3 October 1992
...
* movement,
* medical decisions,
* and countless aspects of daily life.
...
* exhausting workers while claiming labor shortages,
* exploiting artists while lamenting declining creativity,
* extracting trust while eroding the relationships that created trust,
* maximizing short-term revenue at the expense of long-term capability.
...
* talent belongs to the institution,
* identity belongs to the institution,
* reputation belongs to the institution,
* conscience belongs to the institution,
* relationships belong to the institution.
...
* **What problem was this institution created to solve?**
* **What authority was actually entrusted to it?**
* **Whose flourishing justifies its continued existence?**
